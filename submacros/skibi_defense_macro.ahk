...
global exe_path64 := ((A_Is64bitOS && FileExist("AutoHotkey64.exe")) ? (A_MacroWorkingDir "submacros\AutoHotkey64.exe") :
    A_AhkPath)
...
; game arrays
global ChapterNames := ["Chapter 1", "Chapter 2", "Chapter 3", "Chapter 4", "Chapter 5", "Chapter 6", "Nightmare 3",
    "Nightmare 4", "Nightmare 1", "Nightmare 2", "Nightmare 6", "Nightmare 5", "Endless", "Endless Shield"]
global ChapterNamesList := ["Chapter 1", "Chapter 2", "Chapter 3", "Chapter 4", "Chapter 5", "Chapter 6", "Endless",
    "Endless Shield", "Nightmare 1", "Nightmare 2", "Nightmare 3", "Nightmare 4", "Nightmare 5", "Nightmare 6"]
global UnitNames := ["Cameraman", "Large Cam", "Scientist Cam", "Camerawoman", "Dancing Cam", "Cam Strider",
    "Laser Cam", "Upg Cam", "HTC", "Plunger", "Engineer Cam", "General Cameraman", "Upg Camerawoman", "Mech", "TCM",
    "LRC", "Flamethrower", "Glitch Plunger", "UTCM", "LLC", "Upg Mech", "ALC", "UCS", "ULLC", "Orbital", "Fred",
    "Ult Cam", "AUTC", "Speakerman", "Large Speakerman", "Helicopter Speaker", "Speaker Strider", "Upg Knife Speaker",
    "DJ Woman", "DSM", "TSM", "Upg DJ Woman", "UTSM", "Alliance DJ", "Ult Speakerman", "HCUTSM", "TV Man", "TV Woman",
    "Big TV Man", "loud big tv", "Upgraded TV Man", "TTVM", "Energised TV Man", "Ult TV Man", "UTTVM", "Clockwoman",
    "General Clockman", "Large Clockman", "Guardian Clockman", "Clock Titan", "Future Large Clock", "Timer Clockman",
    "Normal Toilet", "Rocket Toilet", "Chill Toilet", "Mafia Boss Toilet", "Mutant Woman oiler", "TCT",
    "Katana Mutant Toilet", "Scythe Mutant Toilet", "G-Toilet 3", "TST", "Buff Mutant Toilet", "Cat Toilet",
    "G-Toilet 5", "Astro UFO", "Astro Detainer", "Mini Juggernaut", "Astro Juggernaut", "Secret Agent", "Chair",
    "Six Lens"]
global UnitNamesList := ["ALC", "Alliance DJ", "Astro Detainer", "Astro Juggernaut", "Astro UFO", "AUTC", "Big TV Man",
    "Buff Mutant Toilet", "Cam Strider", "Cameraman", "Camerawoman", "Cat Toilet", "Chair", "Chill Toilet",
    "Clock Titan", "Clockwoman", "Dancing Cam", "DJ Woman", "DSM", "Energised TV Man", "Engineer Cam", "Flamethrower",
    "Fred", "Future Large Clock", "G-Toilet 3", "G-Toilet 5", "General Cameraman", "General Clockman", "Glitch Plunger",
    "Guardian Clockman", "HCUTSM", "Helicopter Speaker", "HTC", "Katana Mutant Toilet", "Large Cam", "Large Clockman",
    "Large Speakerman", "Laser Cam", "LLC", "loud big tv", "LRC", "Mafia Boss Toilet", "Mech", "Mini Juggernaut",
    "Mutant Woman oiler", "Normal Toilet", "Orbital", "Plunger", "Rocket Toilet", "Scientist Cam",
    "Scythe Mutant Toilet", "Secret Agent", "Six Lens", "Speaker Strider", "Speakerman", "TCM", "TCT", "Timer Clockman",
    "TSM", "TST", "TTVM", "TV Man", "TV Woman", "UCS", "ULLC", "Ult Cam", "Ult Speakerman", "Ult TV Man", "Upg Cam",
    "Upg Camerawoman", "Upg DJ Woman", "Upg Knife Speaker", "Upg Mech", "Upgraded TV Man", "UTCM", "UTSM", "UTTVM"]
...
try {
    AsyncHTTPRequest("GET", "https://api.github.com/repos/NZMacros/SkibiDefenseMacro/releases/latest",
        sd_AutoUpdateHandler, Map("accept", "application/vnd.github+json"))
}
...
if DetectSpeedEvents = 1 {
    try {
        AsyncHttpRequest("GET",
            "https://raw.githubusercontent.com/NZMacros/GitHub/main/skibi_defense_macro/data/Speedevents.txt",
            sd_AutoSpeedEventHandler, Map("accept", "application/vnd.github.v3.raw"))
    }
}
...
sd_Start(*) {
    ...
    try {
        ...
        MsgBox(
            "Your Roblox window is run as administrator, but the macro is not!`nThis means the macro will be unable to send any inputs to Roblox.`nYou must either reinstall Roblox without administrative rights, or run " MacroName " as admin!`n`nNOTE: It is recommended to stop the macro now, as this issue also causes hotkeys to not work while Roblox is active.",
            "Warning", 0x1030 " T60")
    }
    try {
    ...
    MouseMove((windowX + (windowWidth // 2)), (IsSet(offsetY) ? ((windowY + offsetY) + ((windowHeight - offsetY) // 2)) :
...
sd_CollectDaily() {
    ...
    pBMScreen := Gdip_BitmapFromScreen((IsSet(windowDimensions) ? windowDimensions : windowX "|" (IsSet(offsetY) ? (
        windowY + offsetY) : windowY) "|" windowWidth "|" (IsSet(offsetY) ? (windowHeight - offsetY) : windowHeight)))
...
sd_GoGrind() {
    global YouDied, GameEnded
        ...
        , CurrentChapterNum
        , objective
        , ChapterName1, ChapterStrat1, ChapterGrindMode1, ChapterStratInvertFB1, ChapterStratInvertLR1,
        ChapterMaxSpeed1, ChapterMaxTime1, ChapterReturnType1, ChapterUnitSlots1, ChapterUnitMode1, ChapterUnitSlot11,
        ChapterUnitSlot21, ChapterUnitSlot31, ChapterUnitSlot41, ChapterUnitSlot51, ChapterUnitSlot61,
        ChapterUnitSlot71, ChapterUnitSlot81, ChapterUnitSlot91, ChapterUnitSlot01
        , ChapterName2, ChapterStrat2, ChapterGrindMode2, ChapterStratInvertFB2, ChapterStratInvertLR2,
        ChapterMaxSpeed2, ChapterMaxTime2, ChapterReturnType2, ChapterUnitSlots2, ChapterUnitMode2, ChapterUnitSlot12,
        ChapterUnitSlot22, ChapterUnitSlot32, ChapterUnitSlot42, ChapterUnitSlot52, ChapterUnitSlot62,
        ChapterUnitSlot72, ChapterUnitSlot82, ChapterUnitSlot92, ChapterUnitSlot02
        , ChapterName3, ChapterStrat3, ChapterGrindMode3, ChapterStratInvertFB3, ChapterStratInvertLR3,
        ChapterMaxSpeed3, ChapterMaxTime3, ChapterReturnType3, ChapterUnitSlots3, ChapterUnitMode3, ChapterUnitSlot13,
        ChapterUnitSlot23, ChapterUnitSlot33, ChapterUnitSlot43, ChapterUnitSlot53, ChapterUnitSlot63,
        ChapterUnitSlot73, ChapterUnitSlot83, ChapterUnitSlot93, ChapterUnitSlot03
        , ChapterName, ChapterStrat, ChapterGrindMode, ChapterStratInvertFB, ChapterStratInvertLR, ChapterMaxSpeed,
        ChapterMaxTime, ChapterReturnType, ChapterUnitSlots, ChapterUnitMode, ChapterUnitSlot1, ChapterUnitSlot2,
        ChapterUnitSlot3, ChapterUnitSlot4, ChapterUnitSlot5, ChapterUnitSlot6, ChapterUnitSlot7, ChapterUnitSlot8,
        ChapterUnitSlot9, ChapterUnitSlot0
    ...
    if ChapterOverrideReason = "None" {
        sd_SetStatus("Grinding", ChapterName "`nLimit: " time_limit " - Strategy: " ChapterStrat " - Invert F/B: " ChapterStratInvertFB " - Invert L/R: " ChapterStratInvertLR " - Return via: " ChapterReturnType "`nUnits: " (
            ChapterUnitSlot1 ? ChapterUnitSlot1 (ChapterUnitSlot2 ? ", " ChapterUnitSlot2 (ChapterUnitSlot3 ? ", " ChapterUnitSlot3 (
                ChapterUnitSlot4 ? ", " ChapterUnitSlot4 (ChapterUnitSlot5 ? ", " ChapterUnitSlot5 (ChapterUnitSlot6 ?
                    ", " ChapterUnitSlot6 (ChapterUnitSlot7 ? ", " ChapterUnitSlot7 (ChapterUnitSlot8 ? ", " ChapterUnitSlot8 (
                        ChapterUnitSlot9 ? ", " ChapterUnitSlot9 (ChapterUnitSlot0 ? ", " ChapterUnitSlot0 : "") : "") :
                            "") : "") : "") : "") : "") : "") : "") : ""))
    } else {
        sd_SetStatus("Grinding", "Overrided! Reason: " ChapterOverrideReason " - Chapter: " ChapterName "`nLimit: " time_limit " - Strategy: " ChapterStrat " - Invert F/B: " ChapterStratInvertFB " - Invert L/R: " ChapterStratInvertLR " - Return via: " ChapterReturnType "`nUnits: " (
            ChapterUnitSlot1 ? ChapterUnitSlot1 (ChapterUnitSlot2 ? ", " ChapterUnitSlot2 (ChapterUnitSlot3 ? ", " ChapterUnitSlot3 (
                ChapterUnitSlot4 ? ", " ChapterUnitSlot4 (ChapterUnitSlot5 ? ", " ChapterUnitSlot5 (ChapterUnitSlot6 ?
                    ", " ChapterUnitSlot6 (ChapterUnitSlot7 ? ", " ChapterUnitSlot7 (ChapterUnitSlot8 ? ", " ChapterUnitSlot8 (
                        ChapterUnitSlot9 ? ", " ChapterUnitSlot9 (ChapterUnitSlot0 ? ", " ChapterUnitSlot0 : "") : "") :
...
sd_Grind(strat, index) {
    if (!strats.Has(strat)) {
        global ChapterStrat
        sd_SetStatus("Error", 'Strategy "' strat '" does not exist!`nChanged back to "' (ChapterStrat := strat :=
            StandardChapterDefault[ChapterName]["strat"]) '"')
        IniWrite(ChapterDefault[ChapterName]["strat"] := strat, A_SettingsWorkingDir "game_config.ini", ChapterName,
            "Strat")
    }
    ...
    switch Ch, 0 {
        case "Chapter 1":
            if sd_ImgSearch("Chapters\ch1.png", 10)[1] = 0 { ; if this succeeds, move the mouse here and join
                MouseMove(sd_ImgSearch("Chapters\ch1.png", 10)[2] + 699, sd_ImgSearch("Chapters\ch1.png", 10)[3] + 89),
                MouseMove(sd_ImgSearch("Chapters\ch1.png", 10)[2] + 700, sd_ImgSearch("Chapters\ch1.png", 10)[3] + 90)
                Send "{Click}"
                Sleep 5000
                ...
                if sd_ImgSearch("Chapters\ch1game.png", 10)[1] = 0 {
                    if sd_ImgSearch("Chapters\startgame.png", 10)[1] = 0 {
                        MouseMove(sd_ImgSearch("Chapters\startgame.png", 10)[2] - 1, sd_ImgSearch(
                            "Chapters\startgame.png", 10)[3] + 29), MouseMove(sd_ImgSearch("Chapters\startgame.png", 10
                            )[2], sd_ImgSearch("Chapters\startgame.png", 10)[3] + 30)
                        Sleep(250), Send("{Click}")
                        sd_SetStatus("Joining", "Game")
                        pBMScreen := Gdip_BitmapFromScreen((IsSet(windowDimensions) ? windowDimensions : windowX "|" (
                            IsSet(offsetY) ? (windowY + offsetY) : windowY) "|" windowWidth "|" (IsSet(offsetY) ? (
                                windowHeight - offsetY) : windowHeight)))
                        loop {
                            if sd_ImgSearch("Chapters\readygame.png", 10)[1] = 0 {
                                ...
                                Sleep(250), Send("{Click}")*/
                                global InLobby := 1
                                PostScriptsMessage("StatMonitor", 0x5556, InLobby), PostScriptsMessage("background",
                                    0x5557, InLobby)
                                Send "{" Z "}"
                                sd_SetStatus("Joined", ChapterName)
                                return 1
                        ...
                        loop { ;  enable low quality mode
                            if Gdip_ImageSearch(pBMScreen, bitmaps["settingsicon"], &pos, , , , , 15) = 1 {
                                ...
                                Sleep(250), Send("Click")*/
                                global InLobby := 1
                                PostScriptsMessage("StatMonitor", InLobby), PostScriptsMessage("background", 0x5557,
                                    InLobby)
                                Send "{" Z "}"
                                sd_SetStatus("Joined", ChapterName)
                                return 1
                    ...
                    if sd_ImgSearch("Chapters\disbandparty.png", 15)[1] = 0 {
                        MouseMove(sd_ImgSearch("Chapters\disbandparty.png", 15)[2] + 9, sd_ImgSearch(
                            "Chapters\disbandparty.png", 15)[3] + 24), MouseMove(sd_ImgSearch(
                                "Chapters\disbandparty.png", 15)[2] + 10, sd_ImgSearch("Chapters\disbandparty.png", 15)[
                                    3] + 25)
                        Sleep(250), Send("{Click}")
                    } else {
                        return -1
                    }
                    MouseMove((windowX + (windowWidth // 2)), (IsSet(offsetY) ? ((windowY + offsetY) + ((windowHeight -
                        offsetY) // 2)) : (windowY + (windowHeight // 2))))
                    loop {
...
sd_LogError(Error) {
    ...
    System Info:
    - OS: " A_OSVersion "
    - Bitness: " (A_PtrSize * 8) "-bit
    - AutoHotkey: v" A_AhkVersion "
    - Working Dir: " A_MacroWorkingDir "
...
sd_DebugInfo() {
    info := "DEBUG INFORMATION`n"
        ...
        . "Previous Action: " PreviousAction "`n"
        . "Current Chapter: " CurrentChapter "`n"
        . "In Lobby: " InLobby "`n"
        . "Macro Start Time: " MacroStartTime "`n"
        . "Game Start Time: " GameStartTime "`n"
        . "Reconnect Delay: " ReconnectDelay "`n"
        . "========================`n"
