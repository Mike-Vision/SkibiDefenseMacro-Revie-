; main GUI
VersionTextEdit := MainGUI.AddText("x482 y282 vVersionText", "v" VersionID), VersionTextEdit.Move(494 - (VersionWidth :=
TextExtent("v" VersionID, VersionTextEdit)))
hBM := Gdip_CreateHBITMAPFromBitmap(bitmaps["WarningIcon"])
MainGUI.AddPicture("+BackgroundTrans x" 345 - VersionWidth - 5 " y280 w14 h14 Hidden vUpdateButton", "HBITMAP:*" hBM).OnEvent(
"Click", sd_AutoUpdateGUI)
DllCall("DeleteObject", "Ptr", hBM)
hBM := Gdip_CreateHBITMAPFromBitmap(bitmaps["GitHubIcon"])
MainGUI.AddPicture("+BackgroundTrans x" 470 - VersionWidth - 3 " y271 w25 h23 vGitHubButton", "HBITMAP:*" hBM).OnEvent(
"Click", OpenGitHub)
DllCall("DeleteObject", "Ptr", hBM)
pBM := Gdip_BitmapConvertGray(bitmaps["DiscordIcon"]), hBM := Gdip_CreateHBITMAPFromBitmap(pBM)
MainGUI.AddPicture("+BackgroundTrans x" 440 - VersionWidth - 2 " y271 w25 h24 vDiscordButton", "HBITMAP:*" hBM).OnEvent(
"Click", DiscordServer)
Gdip_DisposeImage(pBM), DllCall("DeleteObject", "Ptr", hBM)
MainGUI.SetFont("s8 w700 c0046ee")
MainGUI.AddText("x" 365 - VersionWidth - 5 " y271 +Center vDiscordText", "Made by`nNegativeZero").OnEvent("Click",
DiscordProfile) ; increasing the left value moves it right, increasing the right value moves it left
MainGUI.SetFont("s8 cDefault Norm")
MainGUI.AddButton("x10 y275 w65 h20 -Wrap vStartButton Disabled", " Start (" StartHotkey ")").OnEvent("Click",
StartButton)
MainGUI.AddButton("x80 y275 w65 h20 -Wrap vPauseButton Disabled", " Pause (" PauseHotkey ")").OnEvent("Click",
PauseButton)
...
MainGUI.AddText("x122 y254 w73 +Center +BackgroundTrans +Border vCurrentChapter", CurrentChapter := ChapterName%
CurrentChapterNum%)
MainGUI.AddText("x265 y254 w230 +BackgroundTrans +Border vCurrentState", "Startup: GUI")

; Loading overlay / status elements
MainGUI.SetFont("s12 w700 c000000")
MainGUI.AddText("x0 y120 w500 h30 +Center +BackgroundTrans vLoadPercent", "Loading assets... 0%")
MainGUI.SetFont("s8 cDefault Norm", "Tahoma")
MainGUI.AddText("x0 y150 w500 h40 +Center +BackgroundTrans vOffsetWarning Hidden", "")
MainGUI.AddButton("x210 y195 w80 h22 vRetryOffset Hidden", "Retry Offset").OnEvent("Click", sd_RetryOffset)
...
(TabCtrl := MainGUI.Add("Tab", "x0 y-1 w500 h250 -Wrap", TabArr)
).OnEvent("Change", (*) => TabCtrl.Focus())
...
(ChapterName1Edit := MainGUI.AddDropDownList("x18 y57 w106 Disabled vChapterName1Edit", ChapterNamesList)).Text :=
    ChapterName1, ChapterName1Edit.OnEvent("Change", sd_ChapterSelect1)
(ChapterName2Edit := MainGUI.AddDropDownList("xp yp+60 wp Disabled vChapterName2Edit", ["None"])).Add(ChapterNamesList),
ChapterName2Edit.Text := ChapterName2, ChapterName2Edit.OnEvent("Change", sd_ChapterSelect2)
(ChapterName3Edit := MainGUI.AddDropDownList("xp yp+60 wp Disabled vChapterName3Edit", ["None"])).Add(ChapterNamesList),
ChapterName3Edit.Text := ChapterName3, ChapterName3Edit.OnEvent("Change", sd_ChapterSelect3)
...
(ChapterStrat1Edit := MainGUI.AddDropDownList("x129 y57 w112 Disabled vChapterStrat1", stratslist)).Text :=
    ChapterStrat1
...
(ChapterGrindMode1Edit := MainGUI.AddDropDownList("x244 y57 w85 Disabled vChapterGrindMode1", GrindModesArr)).Text :=
    ChapterGrindMode1
ChapterGrindMode1Edit.Section := "Game", ChapterGrindMode1Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterGrindMode2Edit := MainGUI.AddDropDownList("xp yp+60 wp Disabled vChapterGrindMode2", GrindModesArr)).Text :=
    ChapterGrindMode2
ChapterGrindMode2Edit.Section := "Game", ChapterGrindMode2Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterGrindMode3Edit := MainGUI.AddDropDownList("xp yp+60 wp Disabled vChapterGrindMode3", GrindModesArr)).Text :=
    ChapterGrindMode3
...
MainGUI.AddText("xp yp+60", "Invert:")
(ChapterStratInvertFB1Edit := MainGUI.AddCheckBox("x171 y92 Disabled vChapterStratInvertFB1 Checked" ChapterStratInvertFB1,
    "F/B")).Section := "Game", ChapterStratInvertFB1Edit.OnEvent("Click", sd_UpdateConfigShortcut)
(ChapterStratInvertFB2Edit := MainGUI.AddCheckBox("xp yp+60 Disabled vChapterStratInvertFB2 Checked" ChapterStratInvertFB2,
    "F/B")).Section := "Game", ChapterStratInvertFB2Edit.OnEvent("Click", sd_UpdateConfigShortcut)
(ChapterStratInvertFB3Edit := MainGUI.AddCheckBox("xp yp+60 Disabled vChapterStratInvertFB3 Checked" ChapterStratInvertFB3,
    "F/B")).Section := "Game", ChapterStratInvertFB3Edit.OnEvent("Click", sd_UpdateConfigShortcut)
(ChapterStratInvertLR1Edit := MainGUI.AddCheckBox("x211 y92 Disabled vChapterStratInvertLR1 Checked" ChapterStratInvertLR1,
    "L/R")).Section := "Game", ChapterStratInvertLR1Edit.OnEvent("Click", sd_UpdateConfigShortcut)
(ChapterStratInvertLR2Edit := MainGUI.AddCheckBox("xp yp+60 Disabled vChapterStratInvertLR2 Checked" ChapterStratInvertLR2,
    "L/R")).Section := "Game", ChapterStratInvertLR2Edit.OnEvent("Click", sd_UpdateConfigShortcut)
(ChapterStratInvertLR3Edit := MainGUI.AddCheckBox("xp yp+60 Disabled vChapterStratInvertLR3 Checked" ChapterStratInvertLR3,
    "L/R")).Section := "Game", ChapterStratInvertLR3Edit.OnEvent("Click", sd_UpdateConfigShortcut)

MainGUI.AddText("x260 y81 h10", "Max Speed:")
MainGUI.AddText("xp yp+60 hp", "Max Speed:")
MainGUI.AddText("xp yp+60 hp", "Max Speed:")
(ChapterMaxSpeed1Edit := MainGUI.AddEdit("x" (SpeedEvent ? "250" : "270") " y96 w40 h18 vChapterMaxSpeed1 Number Limit1" (
    SpeedEvent ? " Disabled" : ""), ChapterMaxSpeed1)).OnEvent("Change", (*) => sd_MaxSpeed(ChapterMaxSpeed1Edit, 1))
MainGUI.AddUpDown("vChapterMaxSpeed1Edit Range1-5 Disabled", ChapterMaxSpeed1).OnEvent("Change", (*) => sd_MaxSpeed(
    ChapterMaxSpeed1Edit, 1))
(ChapterMaxSpeed2Edit := MainGUI.AddEdit("x" (SpeedEvent ? "250" : "270") " yp+60 w40 h18 vChapterMaxSpeed2 Number Limit1" (
    SpeedEvent ? " Disabled" : ""), ChapterMaxSpeed2)).OnEvent("Change", (*) => sd_MaxSpeed(ChapterMaxSpeed2Edit, 2))
MainGUI.AddUpDown("vChapterMaxSpeed2Edit Range1-5 Disabled", ChapterMaxSpeed2).OnEvent("Change", (*) => sd_MaxSpeed(
    ChapterMaxSpeed2Edit, 2))
(ChapterMaxSpeed3Edit := MainGUI.AddEdit("x" (SpeedEvent ? "250" : "270") " yp+60 w40 h18 vChapterMaxSpeed3 Number Limit1" (
    SpeedEvent ? " Disabled" : ""), ChapterMaxSpeed3)).OnEvent("Change", (*) => sd_MaxSpeed(ChapterMaxSpeed3Edit, 3))
MainGUI.AddUpDown("vChapterMaxSpeed3Edit Range1-5 Disabled", ChapterMaxSpeed3).OnEvent("Change", (*) => sd_MaxSpeed(
    ChapterMaxSpeed3Edit, 3))
hBM := Gdip_CreateHBITMAPFromBitmap(bitmaps["Speedevent"])
MainGUI.AddPicture("+BackgroundTrans x290 y93 w23 h24 vSpeedEventNotice2" (!SpeedEvent ? " Hidden" : ""), "HBITMAP:*" hBM
).OnEvent("Click", sd_SpeedEventNotice)
MainGUI.AddPicture("+BackgroundTrans x290 yp+60 w23 h24 vSpeedEventNotice1" (!SpeedEvent ? " Hidden" : ""), "HBITMAP:*" hBM
).OnEvent("Click", sd_SpeedEventNotice)
MainGUI.AddPicture("+BackgroundTrans x290 yp+60 w23 h24 vSpeedEventNotice3" (!SpeedEvent ? " Hidden" : ""), "HBITMAP:*" hBM
).OnEvent("Click", sd_SpeedEventNotice)
DllCall("DeleteObject", "Ptr", hBM)
...
(ChapterMaxTime1Edit := MainGUI.AddEdit("x354 y58 w36 h20 Limit4 Number vChapterMaxTime1 Disabled", ValidateInt(&
    ChapterMaxTime1, 15))).Section := "Game", ChapterMaxTime1Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterMaxTime2Edit := MainGUI.AddEdit("xp yp+60 wp h20 Limit4 Number vChapterMaxTime2 Disabled", ValidateInt(&
    ChapterMaxTime2, 15))).Section := "Game", ChapterMaxTime2Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterMaxTime3Edit := MainGUI.AddEdit("xp yp+60 wp h20 Limit4 Number vChapterMaxTime3 Disabled", ValidateInt(&
    ChapterMaxTime3, 15))).Section := "Game", ChapterMaxTime3Edit.OnEvent("Change", sd_UpdateConfigShortcut)
...
MainGUI.SetFont("s8 cDefault Norm", "Tahoma")
MainGUI.AddCheckBox("x85 y23 Disabled vReverseStatusLog Checked" ReversedStatusLog, "Reverse Order").OnEvent("Click",
    sd_ReverseStatusLog)
...
MainGUI.AddButton("xp+12 yp+2 w12 h12 vDiscordIntegrationDocumentation Disabled", "*").OnEvent("Click",
sd_DiscordIntegrationDocumentation)
MainGUI.AddButton("x265 y202 w215 h24 vDiscordIntegrationGUI Disabled", "Change Discord Settings").OnEvent("Click",
...
(ThemesEdit := MainGUI.AddDropDownList("x75 y76 w72 h100 vGUITheme Disabled", ThemesList)).Text := GUITheme, ThemesEdit
    .OnEvent("Change", sd_GUITheme)
MainGUI.AddCheckBox("x15 y40 vAlwaysOnTop Disabled Checked" AlwaysOnTop, "Always On Top").OnEvent("Click",
    sd_AlwaysOnTop)
...
MainGUI.AddUpDown("xp+21 yp-1 h16 -16 Range0-14 vGUITransparencyUpDown Disabled", GUITransparency // 5).OnEvent(
    "Change", sd_GUITransparency)
MainGUI.AddButton("x14 y100 w150 h20 vAdvancedOptions Disabled", "Advanced Options").OnEvent("Click",
    sd_AdvancedOptionsGUI)
MainGUI.AddButton("x15 y155 w150 h20 vHotkeyGUI Disabled", "Change Hotkeys").OnEvent("Click", sd_HotkeyGUI)
MainGUI.AddButton("x16 yp+24 w150 h20 vAutoClickerGUI Disabled", "AutoClicker Settings").OnEvent("Click",
    sd_AutoClickerGUI)
MainGUI.AddButton("x20 yp+24 w140 h20 vHotkeyRestore Disabled", "Restore Defaults").OnEvent("Click",
...
MainGUI.AddButton("x227 yp+27 w120 h20 vSettingsRestore Disabled", "Reset Settings").OnEvent("Click",
...
(FallbackEdit := MainGUI.AddCheckBox("x230 y210 w132 h15 vPublicFallback Disabled Checked" PublicFallback,
    "Fallback to Public Server")).Section := "Settings", FallbackEdit.OnEvent("Click", sd_UpdateConfigShortcut)
...
(LanguageEdit := MainGUI.AddDropDownList("x360 y65 vLanguageEdit Disabled", LangArr)).Text := Language, LanguageEdit.OnEvent(
    "Change", sd_Language)
...
MainGUI.AddButton("x15 y65 w150 h20 vMakeSuggestions Disabled", "Make a Suggestion").OnEvent("Click",
    sd_MakeSuggestionButton)
MainGUI.AddButton("x15 y90 w150 h32 vReportSecurityBreaches Disabled", "Report a Security Vulnerability").OnEvent(
    "Click", sd_ReportSecurityVulnerabilitiesButton)
MainGUI.AddButton("x15 y125 w150 h20 vAskQuestions Disabled", "Ask a Question").OnEvent("Click",
    sd_MacroQuestionsButton)
; sd server
MainGUI.AddButton("x15 y175 h30 vDankMemerAutoGrinder Disabled", "Dank Memer AutoGrinder").OnEvent("Click",
    sd_DMAGPriorWarning)
MainGUI.AddButton("x155 y179 w20 h20 vDMAGDefinition Disabled", "?").OnEvent("Click", sd_DMAGDefinition)
MainGUI.AddText("x20 y210 vDoesItWork Disabled", '"Does it work" counter: 118').OnEvent("Click",
    sd_CommunityCreationsPost)
; other
MainGUI.AddButton("x210 y40 vRandomStringGenerator Disabled", "Random String Generator").OnEvent("Click",
...
MainGUI.SetFont("s8 cDefault Norm", "Tahoma")
MainGUI.AddText("x18 y43 w225 +Wrap +BackgroundTrans cWhite",
    "Special thanks to those who tested the macro,`nClick the names to view their Discord profiles!")
...
try {
    AsyncHTTPRequest("GET",
        "https://raw.githubusercontent.com/NZMacros/GitHub/main/skibi_defense_macro/data/contributors.txt",
        sd_ContributorsHandler, Map("accept", "application/vnd.github.v3.raw"))
}
...
SetLoadProgress(percent, Title1, Title2 := Title1) {
    ...
    if percent < 100 {
        ...
        try {
            MainGUI["vLoadPercent"].Text := percent "% - Loading assets..."
        } catch {
        }
        ...
        try {
            MainGUI["vLoadPercent"].Text := ""
            if IsObject(MainGUI["vOffsetWarning"]) {
                MainGUI["vOffsetWarning"].Text := ""
            }
            MainGUI["vRetryOffset"].Hide()
        } catch {
        }
        MainGUI.Flash()
        MainGUI.Restore()
    ...
    if percent > 100 {
        throw ValueError('"percent" exceeds max value of 100.', -2,
            '"percent" should only be a value between 1 and 100.')
    }
}

sd_AlwaysOnTop(*) {
    global
    IniWrite((AlwaysOnTop := MainGUI["AlwaysOnTop"].Value), A_SettingsWorkingDir "main_config.ini", "Settings",
    "AlwaysOnTop")
...
sd_RetryOffset(*) {
    try {
        MainGUI.Opt("+Disabled")
        MainGUI["vOffsetWarning"].Text := "Retrying offset detection..."
        MainGUI["vLoadPercent"].Text := "Detecting window..."
    } catch {
    }
    ; Re-run display check
    try {
        OffsetDetectionFailed := 0
        CheckDisplaySpecs()
    } catch {
    }
    ; Update GUI according to result
    try {
        if (IsSet(OffsetDetectionFailed) && OffsetDetectionFailed = 0) {
            MainGUI["vOffsetWarning"].Text := "Offset detected — you can continue."
            MainGUI["vLoadPercent"].Text := ""
            MainGUI["vRetryOffset"].Hide()
        } else {
            MainGUI["vOffsetWarning"].Text := "Offset detection still failing. Check display settings and retry."
            MainGUI["vRetryOffset"].Show()
        }
    } catch {
    }
    MainGUI.Opt("-Disabled")
...
sd_RegDumpHelp(*) {
MsgBox(
    "Registry dumper is a gimmick that I (NegativeZero) wanted to test from within the macro.`n`nRegistry dumper exports the contents of the specified path in your registry editor to the dump path, giving information on the full path, item, type and value (you may need to run it as administrator for some of these if you encounter issues).",
    "RegDump Help", 0x1020 " T90")
}

sd_DMAGPriorWarning(*) {
if (MsgBox(
    "Use this at your own risk!!!`nAs stated in the macro's license, only you are responsible for any damages or issues caused by macroing Dank Memer!`n`nClick confirm to continue to the GUI.",
    "DMAG Warning", 0x1031) = "OK") {
...
sd_SpeedEventNotice(*) {
MsgBox(
    "Following a global speed event in Skibi Defense, your max speed has been automatically updated to the global of " SpeedEvent "x.`n`nIf you do not want this to happen again, disable the checkbox above and reload (press " StopHotkey ").",
    "Speed Events", 0x1020 " T80 Owner" MainGUI.Hwnd)
}
...
if GUICtrl.Value = "" {
    MsgBox(
        "Speed cannot be empty!!`n`nInstead, highlight the existing value to replace it rather than deleting the value and retyping it.",
        "Max Speed", 0x1030 " T60 Owner" MainGUI.Hwnd)
    ...
    IniWrite((ChapterMaxSpeed%charNum% := GUICtrl.Value), A_SettingsWorkingDir "main_config.ini", "Game",
    "ChapterMaxSpeed" charNum)
}
}

sd_DetectSpeedEvents(*) {
global
IniWrite((DetectSpeedEvents := AdvancedOptionsGUI["DetectSpeedEvents"].Value), A_SettingsWorkingDir "main_config.ini",
"Game", "DetectSpeedEvents")
}
...
if !(%k% ~= "^[!^+]+$") {
    ...
    switch Format("sc{:03X}", GetKeySC(%k%)), 0 {
        case FwdKey, LeftKey, BackKey, RightKey, SC_Space:
            GUICtrl.Value := %v%
            MsgBox("That hotkey cannot be used!`nThe key is already used for movement.", "Unnaceptable Hotkey",
                0x1030)
            return

        case ZoomIn, ZoomOut, RotUp, RotDown, RotRight, RotLeft, SC_Esc, SC_Enter, SC_LShift, SC_Q, SC_E, SC_R,
            SC_Y, SC_L, SC_Z, SC_X, SC_N:
            GUICtrl.Value := %v%
            MsgBox("That hotkey cannot be used!`nThe key is already used elsewhere in the macro.",
                "Unnaceptable Hotkey", 0x1030)
            return

        case SC_0, SC_1, SC_2, SC_3, SC_4, SC_5, SC_6, SC_7, SC_8, SC_9:
            GUICtrl.Value := %v%
            MsgBox("That hotkey cannot be used!`nIt will be needed to place your units.", "Unnaceptable Hotkey",
                0x1030)
            return
    }

    if ((StrLen(%k%) = 0) || (%k% = StartHotkey) || (%k% = PauseHotkey) || (%k% = StopHotkey) || (%k% =
        AutoClickerHotkey)) { ; do not allow empty or already used hotkey (not necessary in most cases)
        GUICtrl.Value := %v%
        MsgBox(
            "That hotkey cannot be used!`nThe key is already used as a different hotkey.`n`nIf you wish to use this hotkey, please remove it from the other one (Key: " %
            k% ").", "Unnaceptable Hotkey", 0x1030)
        ...
        (l != "AutoClicker") ? (MainGUI[l "Button"].Text := " " l " (" %v% ")") : (IsSet(AutoClickerGUI) ? (
            AutoClickerGUI["StartAutoClicker"].Text := "Start (" AutoClickerHotkey ")") : "")
        try {
...
sd_ResetHotkeysButton(*) {
sd_LockTabs()
if (MsgBox("Are you sure you would like to reset your confirgurations for Hotkeys?`nThis action cannot be undone!",
    "Reset Hotkeys", 0x1024 " Owner" MainGUI.Hwnd) = "Yes") {
    sd_ResetHotkeys()
}
sd_LockTabs(0)
}
...
sd_LockTabs()
if (MsgBox(
    "Are you sure you would like to reset your confirgurations for the macro?`nThis action cannot be undone!",
    "Reset Macro Configurations", 0x1024 " Owner" MainGUI.Hwnd) = "Yes") {
    sd_ResetSettings()
    sd_Close()
}
sd_LockTabs(0)
...
IniWrite((IgnoredUpdateVersion := VersionID), A_SettingsWorkingDir "main_config.ini", "Settings",
"IgnoredUpdateVersion")
IniWrite((DankMemerJob := "Unemployed"), A_SettingsWorkingDIr "main_config.ini", "Miscellaneous", "DankMemerJob")
IniWrite((DankMemerJobCooldown := 0), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
"DankMemerJobCooldown")
IniWrite((DankMemerSlashCommands := 1), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
"DankMemerJobCooldown")
...
IniWrite((RegLogPath := "HKEY_LOCAL_MACHINE"), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
"RegLogPath")
...
FileDelete(A_SettingsWorkingDir "debug_log.txt"), FileAppend("[" A_DD "/" A_MM "][" A_Hour ":" A_Min ":" A_Sec "] Hello world!`n",
    A_SettingsWorkingDir "debug_log.txt")
IniWrite((FirstTime := 1), A_SettingsWorkingDir "main_config.ini", "Miscellaneous", "FirstTime")
}

sd_ResetGameConfigButton(*) {
sd_LockTabs()
if (MsgBox("Are you sure you would like to reset your game configurations?`nThis action cannot be undone!",
    "Reset Game Config", 0x1024 " Owner" MainGUI.Hwnd) = "Yes") {
    sd_ResetGameConfig()
}
sd_LockTabs(0)
}
...
sd_ResetGameConfig() {
global
IniWrite((ChapterName1 := ChapterName1Edit.Text := "Chapter 1"), A_SettingsWorkingDir "main_config.ini", "Game",
"ChapterName1")
IniWrite((ChapterName2 := ChapterName2Edit.Text := "None"), A_SettingsWorkingDir "main_config.ini", "Game",
"ChapterName2")
IniWrite((ChapterName3 := ChapterName3Edit := "None"), A_SettingsWorkingDir "main_config.ini", "Game",
"ChapterName3")
IniWrite((GrindMode := GrindModeEdit.Text := "Loss Farm"), A_SettingsWorkingDir "main_config.ini", "Game",
"GrindMode")
IniWrite((UnitMode := UnitModeEdit.Text := "Preset"), A_SettingsWorkingDir "main_config.ini", "Game", "UnitMode")
IniWrite((UnitSlot1 := UnitSlot1Edit.Text := "Cameraman"), A_SettingsWorkingDir "main_config.ini", "Game",
"UnitSlot1")
...
MsgBox(
    "When this option is enabled, the macro will revert to attempting to join a Public Server if your Server Link failed three times.`nOtherwise, it will keep trying the Server Link you entered above until it succeeds.",
...
RegExMatch(str,
    "i)((http(s)?):\/\/)?((www|web)\.)?roblox\.com\/games\/14279693118\/?([^\/]*)\?privateServerLinkCode=.{32}(\&[^\/]*)*", &
    NewPrivServer)
if ((StrLen(str) > 0) && !IsObject(NewPrivServer)) {
    GUICtrl.Value := %k%
    SendMessage 0xB1, p - 2, p - 2, GUICtrl
    if InStr(str, "/share?code") {
        sd_ErrorBalloon(GUICtrl, "Unresolved Private Server Link",
            'You entered a "share?code" link! To fix this, follow these steps:`n    1. Paste the link into your browser`n    2. Wait for Skibi Defense to load`n    3. Copy the link at the top of your browser'
        )
    } else {
        sd_ErrorBalloon(GUICtrl, "Invalid Private Server Link",
            "Make sure your link:`r`    - Is copied correctly and completely`r`n    - Is for Skibi Defense by Archkos Studios`n    - Does not have a language specification"
        )
    }
} else {
...
if (!IsSet(MainGUI) || !MainGUI)
    return
wp := Buffer(44)
DllCall("GetWindowPlacement", "Ptr", MainGUI.Hwnd, "Ptr", wp.Ptr)
x := NumGet(wp, 28, "Int")
y := NumGet(wp, 32, "Int")
if (x > 0) {
...
AdvancedOptionsGUI.AddButton("x265 y55 w40 h120 vStartupManagerGUI", "Open Macro on Startup").OnEvent("Click",
    sd_StartupManager)
AdvancedOptionsGUI.AddText("x265 y25", "Custom Reconnect Message:")
AdvancedOptionsGUI.AddEdit("x410 y22 w200 h20 vCustomReconnectMessage", ReconnectMessage).OnEvent("Change",
    sd_SaveReconnectMessage)
AdvancedOptionsGUI.AddButton("x310 y55 vResetAdvancedOptions", "Reset Configs").OnEvent("Click",
    sd_ResetAdvancedOptionsButton)
(DetectSpeedEventsEdit := AdvancedOptionsGUI.AddCheckBox("x312 y80 vDetectSpeedEvents Checked" DetectSpeedEvents,
    "Automatically detect global speed events")).Section := "Game", DetectSpeedEventsEdit.OnEvent("Click",
        sd_UpdateConfigShortcut)
...
; debugging
(DebuggingScreenshotsEdit := AdvancedOptionsGUI.AddCheckBox("x15 y142 vDebuggingScreenshots Checked" DebuggingScreenshots,
    "Enable Discord Debugging Screenshots")
).Section := "Discord", DebuggingScreenshotsEdit.OnEvent("Click", sd_UpdateConfigShortcut)
(DebugLogEdit := AdvancedOptionsGUI.AddCheckbox("x15 yp+20 vDebugLogEnabled Checked" DebugLogEnabled,
    "Enable Debug Log")).Section := "Discord", DebugLogEdit.OnEvent("Click", sd_UpdateConfigShortcut)
AdvancedOptionsGUI.Show("w650 h200")
}

sd_SaveReconnectMessage(*) {
global
IniWrite((ReconnectMessage := AdvancedOptionsGUI["CustomReconnectMessage"].Value), A_SettingsWorkingDir "main_config.ini",
...
SMGUI.AddText("x0 yp vNTVal c" ((validScript) ? "Green" : "Red"), (status = 1) ? "None" : (validScript) ? "Valid" :
    "Invalid")
CenterText(SMGUI["NTLabel"], SMGUI["NTVal"], SMGUI["StatusText"])
SMGUI.AddText("x0 yp+20 vASLabel", "Start Macro On Run: ")
SMGUI.AddText("x0 yp vASVal c" ((Startup) ? "Green" : "Red"), (status = 1) ? "None" : (Startup) ? "Enabled" :
    "Disabled")
...
if (task := RegRead("HKCU\Software\Microsoft\Windows\CurrentVersion\Run", "SkibiDefenseMacro", "")) {
    if (MsgBox("Are you sure?`nThis will overwrite the existing " MacroName " Startup!", "Overwrite Existing Entry",
        0x40024 " T30 Owner" SMGUI.Hwnd) != "Yes") {
        return
    }
}
...
try {
    ...
    MsgBox(
        "Failed to create Startup Parameter! This could be due to the fact that the macro does not have sufficient permissions and needs to be run as administrator!",
        "Startup Manager", 0x1020 " T60 Owner" SMGUI.Hwnd)
} else {
    ...
    CenterText(SMGUI["NTLabel"], SMGUI["NTVal"], SMGUI["StatusText"])
    SMGUI["ASVal"].SetFont((Startup = 1) ? "cGreen" : "cRed"), SMGUI["ASVal"].Text := (Startup = 1) ? "Enabled" :
        "Disabled"
    CenterText(SMGUI["ASLabel"], SMGUI["ASVal"], SMGUI["StatusText"])
}
}
...
if (ReconnectMethod = "Deeplink") {
    if (MsgBox(
        'Setting reconnect method to "Browser" is not recommended!`n`nEven if you have problems while using the "Deeplink" method, fixing it is a much better option than using the "Browser" method. Read the [?] for more information.`n`Are you sure you want to change this?',
        "Reconnect Method Warning", 0x1034 " Owner" MainGUI.Hwnd) = 'Yes') {
        i := 1
    } else {
        return
    }
...
MainGUI["ReconnectMethod"].Text := ReconnectMethod := val[(GUICtrl.Name = "RMRight") ? (Mod(i, l) + 1) : (Mod(l + i -
    2, l) + 1)]
...
AutoClickerGUI.AddCheckBox("x110 y2 vClickMode Checked" ClickMode, "Infinite").OnEvent("Click",
...
(ClickCountEdit := AutoClickerGUI.AddUpDown("vClickCount Range0-9999999 Disabled" ClickMode, ClickCount)).Section :=
    "Settings", ClickCountEdit.OnEvent("Change", sd_UpdateConfigShortcut)
AutoClickerGUI.AddText("x133 y27", "times")
AutoClickerGUI.AddText("x10 yp+22", "Click Interval (ms):")
AutoClickerGUI.AddEdit("xp+100 yp-2 w61 h18 vClickDelayEdit Number Limit5", ClickDelay).OnEvent("Change", (*) =>
    sd_UpdateConfigShortcut(ClickDelayEdit))
(ClickDelayEdit := AutoClickerGUI.AddUpDown("vClickDelay Range0-99999", ClickDelay)).Section := "Settings",
    ClickDelayEdit.OnEvent("Change", sd_UpdateConfigShortcut)
AutoClickerGUI.AddText("x10 yp+22", "Click Duration (ms):")
AutoClickerGUI.AddEdit("xp+116 yp-2 w57 h18 vClickDurationEdit Number Limit4", ClickDuration).OnEvent("Change", (*) =>
    sd_UpdateConfigShortcut(ClickDurationEdit))
(ClickDurationEdit := AutoClickerGUI.AddUpDown("vClickDuration Range0-9999", ClickDuration)).Section := "Settings",
    ClickDurationEdit.OnEvent("Change", sd_UpdateConfigShortcut)
...
AutoClickerGui.AddButton("x60 y108 w80 h20 vStartAutoClicker", "Start (" AutoClickerHotkey ")").OnEvent("Click",
    sd_StartAutoClicker)
sd_StartAutoClicker(*) {
    GUIClose()
    MainGUI.Minimize()
...
sd_AutoClickerClickMode(*) {
global
IniWrite (ClickMode := AutoClickerGUI["ClickMode"].Value), A_SettingsWorkingDir "main_config.ini", "Settings",
"ClickMode"
if ClickMode = 1 {
...
AutoClickerGUI["ClickButton"].Text := ClickButton := val[(GUICtrl.Name = "CBRight") ? (Mod(i, l) + 1) : (Mod(l + i -
    2, l) + 1)]
...
sd_LockTabs()
if (MsgBox("Are you sure you would like to reset your total statistics?`nThis action cannot be undone!",
    "Reset Total Statistics", 0x1024 " Owner" MainGUI.Hwnd) = "Yes") {
    sd_ResetTotalStats()
}
sd_LockTabs(0)
}
...
DiscordIntegrationGUI.AddCheckbox("x10 y30 vEnableDiscord Checked" DiscordCheck, "Discord Integration").OnEvent(
    "Click", sd_EnableDiscord)
DiscordIntegrationGUI.AddCheckBox("xp y60 vSetWebhook " DiscordIntegrationDisabled " Checked" DiscordWebhookCheck,
    "Webhook").OnEvent("Click", sd_SetDiscordModetoWebhook)
DiscordIntegrationGUI.AddCheckBox("xp+100 yp vSetBot " DiscordIntegrationDisabled " Checked" DiscordBotCheck, "Bot"
).OnEvent("Click", sd_SetDiscordModetoBot)
(EnableMainChannel := DiscordIntegrationGUI.AddCheckBox("x10 y110 vEnableMainChannel " DiscordIntegrationDisabled " Checked" MainChannelCheck,
    "Main Channel")).OnEvent("Click", sd_EnableMainChannel)
(EnableReportsChannel := DiscordIntegrationGUI.AddCheckBox("x10 y140 vEnableReportsChannel " DiscordIntegrationDisabled " Checked" ReportChannelCheck,
    "Reports Channel")).OnEvent("Click", sd_EnableReportsChannel)
(MainChannelIDEdit := DiscordIntegrationGUI.AddEdit("x100 y107 w150 vMainChannelID " MainChannelEditDisabled,
    MainChannelID)).Section := "Discord", MainChannelIDEdit.OnEvent("Change", sd_UpdateConfigShortcut)
(ReportsChannelIDEdit := DiscordIntegrationGUI.AddEdit("x115 y137 w150 vReportChannelID " ReportsChannelEditDisabled,
    ReportChannelID)).Section := "Discord", ReportsChannelIDEdit.OnEvent("Change", sd_UpdateConfigShortcut)
DiscordIntegrationGUI.AddCheckbox("x275 y3 vEnableUserPings " DiscordIntegrationDisabled " Checked" Criticals,
    "User Pings").OnEvent("Click", sd_EnableUserPings)
DiscordIntegrationGUI.AddText("x170 y30", "User ID:")
(DiscordUserIDEdit := DiscordIntegrationGUI.AddEdit("xp+45 yp-3 w150 vDiscordUserID " PingsDisabled, DiscordUserID))
.Section := "Discord", DiscordUserIDEdit.OnEvent("Change", sd_UpdateConfigShortcut)
(CEPEdit := DiscordIntegrationGUI.AddCheckBox("xp-45 yp+30 vCriticalErrorPings " PingsDisabled " Checked" CriticalErrorPings,
    "Critical Errors")).Section := "Discord", CEPEdit.OnEvent("Click", sd_UpdateConfigShortcut)
(DPEdit := DiscordIntegrationGUI.AddCheckBox("xp+88 yp vDisconnectPings " PingsDisabled " Checked" DisconnectPings,
    "Disconnects")).Section := "Discord", DPEdit.OnEvent("Click", sd_UpdateConfigShortcut)
DiscordIntegrationGUI.AddCheckBox("x400 y90 vEnableDiscordScreenshots " DiscordIntegrationDisabled " Checked" Screenshots,
    "Screenshots").OnEvent("Click", sd_EnableDiscordScreenshots)
(CritSSEdit := DiscordIntegrationGUI.AddCheckBox("x285 y110 vCriticalScreenshots " ScreenshotsDisabled " Checked" CriticalScreenshots,
    "Critical Screenshots")).Section := "Discord", CritSSEdit.OnEvent("Click", sd_UpdateConfigShortcut)
DiscordIntegrationGUI.AddText("x285 y150", "Webhook URL/Bot Token:")
(WebhookURLEdit := DiscordIntegrationGUI.AddEdit("x415 yp-3 w700 vWebhookURL " DiscordIntegrationDisabled " " DiscordMode1Hidden,
    WebhookURL)).Section := "Discord", WebhookURLEdit.OnEvent("Change", sd_UpdateConfigShortcut)
(BotTokenEdit := DiscordIntegrationGUI.AddEdit("x415 yp-3 w700 vBotToken " DiscordIntegrationDisabled " " DiscordMode2Hidden,
    BotToken)).Section := "Discord", BotTokenEdit.OnEvent("Change", sd_UpdateConfigShortcut)
DiscordIntegrationGUI.AddText("x12 y172",
    "Please ignore incorrectly displayed values. When you make a change, it is automatically and instantly saved!`nValues should display correctly next reload."
)
...
MsgBox(
    "Discord Integration allows you to receive notifications through Discord about the status of your macro, allowing you to monitor your macro. Integration can also let you use commands to modify your settings, start/stop your macro etc. all from Discord. If you want to see the mini documentation, click the [*] next to the [?].",
    "Discord Integration Help", 0x20)
}

sd_DiscordIntegrationDocumentation(*) {
Run(
    "https://rawcdn.githack.com/NZMacros/GitHub/main/skibi_defense_macro/docs/DiscordIntegration/DiscordIntegrationDocumentation.html"
)
}

sd_EnableDiscord(*) {
global
IniWrite((DiscordCheck := DiscordIntegrationGUI["EnableDiscord"].Value), A_SettingsWorkingDir "main_config.ini",
"Discord", "DiscordCheck")
if DiscordCheck = 0 {
    IniWrite((MainChannelCheck := DiscordIntegrationGUI["EnableDiscord"].Value), A_SettingsWorkingDir "main_config.ini",
    "Discord", "MainChannelCheck")
    IniWrite((ReportChannelCheck := DiscordIntegrationGUI["EnableDiscord"].Value), A_SettingsWorkingDir "main_config.ini",
    "Discord", "ReportChannelCheck")
}
...
global
DiscordIntegrationGUI["MainChannelID"].Enabled := EnableMainChannel.Value
IniWrite((MainChannelCheck := EnableMainChannel.Value), A_SettingsWorkingDir "main_config.ini", "Discord",
"MainChannelCheck")
}
...
global
DiscordIntegrationGUI["ReportChannelID"].Enabled := EnableReportsChannel.Value
IniWrite((ReportChannelCheck := EnableReportsChannel.Value), A_SettingsWorkingDir "main_config.ini", "Discord",
"ReportChannelCheck")
}
...
IniWrite((Criticals := DiscordIntegrationGUI["EnableUserPings"].Value), A_SettingsWorkingDir "main_config.ini",
"Discord", "Criticals")
}
...
IniWrite((Screenshots := DiscordIntegrationGUI["EnableDiscordScreenshots"].Value), A_SettingsWorkingDir "main_config.ini",
"Discord", "Screenshots")
}
...
sd_ReportBugButton(*) {
Run(
    "https://github.com/NZMacros/GitHub/issues/new?assignees=&labels=type%3Abug%2Cmacro%3Askibi_defense_macro&projects=&template=skibi_defense_macro-bug_report.yml"
)
}

sd_MakeSuggestionButton(*) {
Run(
    "https://github.com/NZMacros/GitHub/issues/new?assignees=&labels=type%3Asuggestion%2Cmacro%3Askibi_defense_macro&projects=&template=skibi_defense_macro-suggestion.yml"
)
}
...
sd_MacroQuestionsButton(*) {
Run(
    "https://github.com/NZMacros/GitHub/issues/new?assignees=&labels=type%3Aquestion%2Cmacro%3Askibi_defense_macro&projects=&template=skibi-defense-macro_question.yml"
)
}
...
sd_LockTabs()
if (MsgBox(
    "Are you sure you would like to reset your confirgurations for Advanced Options?`nThis action cannot be undone!",
    "Reset Advanced Options", 0x1024 " Owner" MainGUI.Hwnd) = "Yes") {
    sd_ResetAdvancedOptions()
}
sd_LockTabs(1)
}
...
sd_LockTabs()
if (MsgBox(
    "Are you sure you would like to reset your confirgurations for Discord Integration?`nThis action cannot be undone!",
    "Reset Discord Integration", 0x1024 " Owner" MainGUI.Hwnd) = "Yes") {
...
if (!RegExMatch(A_Clipboard, "^\s*\{.*\}\s*$")) {
    MsgBox("Your String Format is incorrect!`nMake sure you also copy the " q "{" q " and the " q "}" q, "Warning",
        0x1030 " T60")
    return
}
...
if obj.Has("Name") {
    if (ObjHasValue(ChapterNamesList, obj["Name"])) {
        ...
        MsgBox(
            "The Chapter Name you tried to import is NOT valid!`nMake sure you copied the string correctly.`nSpecific: " obj[
                "Name"], "Warning", 0x1030 " T60")
    }
}
if obj.Has("Strat") {
    if (ObjHasValue(stratslist, obj["Strat"])) {
        ...
        MsgBox(
            "The Strategy you tried to import is NOT valid!`nMake sure you copied the string correctly and have the strategy installed.`nSpecific: " obj[
                "Strat"], "Warning", 0x1030 " T60")
    }
}
if obj.Has("UnitMode") {
    if (ObjHasValue(UnitModesArr, obj["UnitMode"])) {
        ...
        MsgBox(
            "The Unit Mode you tried to import is NOT valid!`nMake sure you copied the string correctly.`nSpecific: " obj[
                "UnitMode"], "Warning", 0x1030 " T60")
    }
}
if obj.Has("UnitSlots") {
    if (ObjHasValue([5, 6, 7, 8, 9, 10], obj["UnitSlots"])) {
        ...
        MsgBox(
            "The amount of Unit Slots you tried to import is NOT valid!`nMake sure you copied the string correctly.`nSpecific: " obj[
                "UnitSlots"], "Warning", 0x1030 " T60")
    }
}
loop 9 {
    local j := A_Index
    if obj.Has("UnitSlot" j) {
        if (ObjHasValue(UnitNamesList, obj["UnitSlot" j])) {
            ...
            MsgBox(
                "The Unit you tried to import is NOT valid!`nMake sure you copied the string correctly.`nSpecific: " obj[
                    "UnitSlot" j], "Warning", 0x1030 " T60")
        }
    }
}
if obj.Has("UnitSlot0") {
    if (ObjHasValue(UnitNamesList, obj["UnitSlot0"])) {
        ...
        MsgBox("The Unit you tried to import is NOT valid!`nMake sure you copied the string correctly.`nSpecific: " obj[
            "UnitSlot0"], "Warning", 0x1030 " T60")
    }
}
for k, v in validation {
    if obj.Has(k) {
        if (obj[k] ~= v) {
            ...
            MsgBox(
                "The item you tried to import is NOT valid!`nMake sure you copied the string correctly.`nSpecific: " k ":" obj[
                    k], "Warning", 0x1030 " T60")
        }
    }
}
sd_ChapterSelect%i%()
...
if ChapterName%i% != "None" {
    if (MsgBox("Update " ChapterName%i%
        "'s default settings with the currently selected settings? These will become the default settings when you change to this chapter.`n`nThe macro will use the updated settings automatically.",
        "Change Chapter Defaults", 0x40044 " Owner" MainGUI.Hwnd) = "Yes") {
...
MainGUI["ChapterReturnType" index].Text := ChapterReturnType%index% := val[(GUICtrl.Name = "CRT" index "Right") ? (
    Mod(i, l) + 1) : (Mod(l + i - 2, l) + 1)]
...
sd_UnitDefinitions(*) {
MsgBox(
    "Having trouble understanding abbreviated or community-modified unit names? Continue on to the following MsgBox's to see a a list of all of them and their corresponding names in the lobby:",
    "Units Glossary", 0x1020 " T60 Owner" MainGUI.Hwnd)
MsgBox(
    "Cameraman - Camera Fighter`n`nLarge Cam - Large Camera`n`nScientist Cam - Researcher Camera`n`nCamerawoman - Camera Sniper Girl`n`nDancing Cam - Dancing Camera`n`nCam Strider - Camera Strider`n`nLaser Cam - Laser Camera`n`nUpg Cam - Upgraded Cameraguy`n`nHTC - High Tech Camera`n`nPlunger - Plunger Camera`n`nEngineer Cam - Engineer Camera`n`nGeneral Cameraman - Camera General`n`nUpg Camerawoman - Upgraded Camera Girl`n`nMech - Mech Camera`n`nTCM - Colossal Cameraguy`n`nLRC - Large Rocket Cameraguy`n`nFlamethrower - Flamethrower Cameraguy`n`nGlitch Plunger - Glitch Cameraguy`n`nUTCM - Upgraded Camera Colossal`n`nLLC - Large Laser Cameraguy`n`nUpg Mech - Upgraded Mech Camera`n`nALC - Astro Large Cameraguy`n`nUCS - Upgraded Camera Strider`n`nULLC - Upgraded Large Laser Cameraguy`n`nOrbital - Orbital Camera`n`nFred - Fred`n`nUlt Cam - Ultimate Cameraguy`n`nAUTC - Astro Upgraded Camera Colossal",
    "Cameras", 0x1020 " Owner" MainGUI.Hwnd)
MsgBox(
    "Speakerman - Speaker Fighter`n`nLarge Speakerman - Large Speaker`n`nHelicopter Speaker - Helicopter Speaker`n`nSpeaker Strider - Speaker Strider`n`nUpg Knife Speaker - Upgraded Knife Speakerguy`n`nDJ Woman - DJ Girl`n`nDSM - Dark Speakerguy`n`nTSM - Speaker Colossal`n`nUpg DJ Woman - Upgraded DJ Girl`n`nUTSM - Upgraded Speaker Colossal`n`nAlliance DJ - Alliance DJ`N`NUlt Speakerman - Ultimate Speakerguy`n`nHCUTSM - Overcharged Upgraded Speaker Colossal",
    "Speakers", 0x1020 " Owner" MainGUI.Hwnd)
MsgBox(
    "TV Man - TV-Person`n`nTV Woman - TV-Girl`n`nBig TV Man - Large TV-Person`n`nloud big tv - Speaker Large TV-Person`n`nUpgraded TV Man - Upgraded TV Guy`n`nTTVM - Titan TV Guy`n`nEnergised TV Man - Energized TV Guy`n`nUlt TV Man - Ultimate TVGuy`n`nUTTVM - Upgraded Colossal TV Guy",
    "TV", 0x1020 " Owner" MainGUI.Hwnd)
MsgBox(
    "Clockwoman - Clock Girl`n`nGeneral Clockman - General Clockman`n`nLarge Clockman - Large Clockman`n`nGuardian Clockman - Guardian Clockman`n`nClock Titan - Colossal Clockman`n`nFuture Large Clock - Future Large Clockman`n`nTimer Clockman - Timer Clockman",
    "The Clockmen", 0x1020 " Owner" MainGUI.Hwnd)
MsgBox(
    "Normal Toilet - Normal Toilet`n`nRocket Toilet - Rocket Toilet`n`nChill Toilet - Chill Pal Toilet`n`nMafia Boss Toilet - Mafia Boss Toilet`n`nMutant Woman oiler - Mutant Woman Toilet`n`nTCT - Colossal Camera Toilet`n`nKatana Mutant Toilet - Katana Mutant Toilet`n`nScythe Mutant Toilet - Scythe Mutant Toilet`n`nG-Toilet 3 - G-Man Toilet 3.0`n`nTST - Colossal Speaker Toilet`n`nBuff Mutant Toilet - Large Buff Mutant Toilet`n`nCat Toilet - Cat Toilet`n`nG-Toilet 5 - Gman 5.0",
    "Toilets", 0x1020 " Owner" MainGUI.Hwnd)
MsgBox(
    "Astro UFO - Space UFO Toilet`n`nAstro Detainer - Space Detainer`n`nMini Juggernaut - Mini Astro Juggernaut`n`nAstro Juggernaut - The Juggernaut",
    "Astros", 0x1020 " Owner" MainGUI.Hwnd)
MsgBox("Secret Agent - Secret Agent`n`nChair - Chair Phase 1`n`nSix Lens - The Strongest Camera", "???", 0x1020 " Owner" MainGUI
    .Hwnd)
}

sd_UnitModesHelp(*) {
MsgBox(
    "There are three different Unit Modes you can select for the macro; Input, Detect and Preset.`nThe following MsgBox's will describe them for you.",
    "Unit Modes Help", 0x1020 " T60 Owner" MainGUI.Hwnd)
MsgBox(
    "Unavailable`n`n`nThis mode allows you to input a custom unit strategy that the macro will use to beat the selected chapters.",
    "Input", 0x1020 " Owner" MainGUI.Hwnd)
MsgBox(
    "Unavailable`n`n`nThis will make the macro detect your units upon joining game and use an algorithm to decide which ones to place first.",
    "Detect", 0x1020 " Owner" MainGUI.Hwnd)
MsgBox(
    "In-development`n`n`nThe macro will give you units you need to equip before-hand to avoid any issues in-game.`n`nUsually, these presets are noob-friendly",
    "Preset", 0x1020 " Owner" MainGUI.Hwnd)
}
...
DankMemerJobsArr := ["Discord Mod", "Babysitter", "Fast Food Cook", "House Wife", "Twitch Streamer", "YouTuber",
    "Professional Hunter", "Professional Fisherman", "Grave Digger", "Bartender", "Robber", "Police Officer",
    "Teacher", "Musician", "Pro Gamer", "Manager", "Developer", "Day Trader", "Santa Claus", "Politician",
    "Veterinarian", "Pharmacist", "Dank Memer Shopkeeper", "Lawyer", "Doctor", "Scientist", "Ghost", "Adventurer"]
(DankMemerJobEdit := DankMemerAutoGrinderGUI.AddDropDownList("x168 y47 vDankMemerJobEdit Disabled", ["Unemployed"]))
.Add(DankMemerJobsArr), DankMemerJobEdit.Text := DankMemerJob, DankMemerJobEdit.OnEvent("Change", sd_DankMemerJob)
(DisplayedDankMemerJobCooldownEdit := DankMemerAutoGrinderGUI.AddText("x175 y75 vDisplayedDankMemerJobCooldown",
    "Cooldown: " (DankMemerJobCooldown // 60000) " minutes."))
DankMemerAutoGrinderGUI.AddCheckBox("x10 y32 vUseSlashCommands Checked" DankMemerSlashCommands, "Message Farm (" ((
    DankMemerSlashCommands = 1) ? "Off" : "On") ")").OnEvent("Click", sd_DMAGswitchNewCmds)
DankMemerAutoGrinderGUI.AddCheckBox("x10 y67 vBegEdit Checked" DankMemerFarmBeg, "Beg Farm").OnEvent("Click",
    sd_DankMemerBegFarm)
...
sd_DankMemerJob(*) {
    IniWrite((DankMemerJob := DankMemerJobEdit.Text), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
    "DankMemerJob")
    if DankMemerJob = "Unemployed" {
        IniWrite((DankMemerJobCooldown := (0 * 60000)), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
        "DankMemerJobCooldown")
    } else if (DankMemerJob = "Discord Mod" || DankMemerJob = "Babysitter") {
        IniWrite((DankMemerJobCooldown := (40 * 60000)), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
        "DankMemerJobCooldown")
    } else if (DankMemerJob = "Fast Food Cook" || DankMemerJob = "House Wife") {
        IniWrite((DankMemerJobCooldown := (43 * 60000)), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
        "DankMemerJobCooldown")
    } else if (DankMemerJob = "Twitch Streamer" || DankMemerJob = "YouTuber") {
        IniWrite((DankMemerJobCooldown := (46 * 60000)), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
        "DankMemerJobCooldown")
    } else if (DankMemerJob = "Professional Hunter" || DankMemerJob = "Professional Fisherman" || DankMemerJob =
        "Grave Digger" || DankMemerJob = "Bartender" || DankMemerJob = "Robber" || DankMemerJob = "Police Officer" ||
        DankMemerJob = "Teacher" || DankMemerJob = "Musician") {
        IniWrite((DankMemerJobCooldown := (49 * 60000)), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
        "DankMemerJobCooldown")
    } else if (DankMemerJob = "Pro Gamer" || DankMemerJob = "Manager" || DankMemerJob = "Developer") {
        IniWrite((DankMemerJobCooldown := (52 * 60000)), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
        "DankMemerJobCooldown")
    } else if (DankMemerJob = "Day Trader" || DankMemerJob = "Santa Claus" || DankMemerJob = "Politician" ||
        DankMemerJob = "Veterinarian" || DankMemerJob = "Pharmacist" || DankMemerJob = "Dank Memer Shopkeeper") {
        IniWrite((DankMemerJobCooldown := (55 * 60000)), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
        "DankMemerJobCooldown")
    } else if (DankMemerJob = "Lawyer" || DankMemerJob = "Doctor" || DankMemerJob = "Scientist" || DankMemerJob =
        "Ghost" || DankMemerJob = "Adventurer") {
        IniWrite((DankMemerJobCooldown := (58 * 60000)), A_SettingsWorkingDir "main_config.ini", "Miscellaneous",
        "DankMemerJobCooldown")
    }
...
sd_DankMemerBegFarm(*) {
global
IniWrite((DankMemerFarmBeg := DankMemerAutoGrinderGUI["BegEdit"].Value), A_SettingsWorkingDir "main_config.ini",
"Miscellaneous", "DankMemerFarmBeg")
}

sd_DMAGswitchNewCmds(*) {
global
IniWrite((DankMemerSlashCommands := DankMemerAutoGrinderGUI["UseSlashCommands"].Value), A_SettingsWorkingDir "main_config.ini",
"Miscellaneous", "DankMemerSlashCommands")
((DankMemerAutoGrinderGUI["UseSlashCommands"].Value = 1) ? (DankMemerAutoGrinderGUI["UseSlashCommands"].Text :=
    "Message Farm (Off)") : (DankMemerAutoGrinderGUI["UseSlashCommands"].Text := "Message Farm (On)"))
}
...
RandomStringGeneratorGUI.AddUpDown("xp+17 yp-1 h16 -16 Range1-93 vRandomStringCountUpDown", RandomStringCount).OnEvent(
    "Change", sd_RandomStringLength)
...
RandomString(*) {
    ...
    FileAppend("<!DOCTYPE html>`n<head>`n<title>SDM Random String</title>`n</head>`n<body>`n<b>" GenerateRandomString() "</b>`n</body>`n</html>",
    A_SettingsWorkingDir "misc\randomstrings\randomstring_" NewFile ".html")
...
RandomStringGeneratorGUI["RandomStringCount"].Text := RandomStringCount := RandomStringGeneratorGUI[
    "RandomStringCountUpDown"].Value
...
StartRegDump(*) {
    ...
    if MsgBox("Complete! Time: " RegDumpTotalTime " minutes.`nOpen dump file?", "RegDump.ahk", 0x1004 " T120") =
    "Yes" {
...
sd_RegDumpPath(*) {
global
IniWrite((RegDumpPath := RegistryDumperGUI["RegPath"].Value), A_SettingsWorkingDir "main_config.ini",
"Miscellaneous", "RegDumpPath")
}

sd_RegLogPath(*) {
global
IniWrite((RegLogPath := RegistryDumperGUI["DumpPath"].Value), A_SettingsWorkingDir "main_config.ini",
"Miscellaneous", "RegLogPath")
}
...
(ChapterUnitSlot11Edit := ChangeLoadout1GUI.AddDropDownList("x30 y33 vChapterUnitSlot11", UnitNamesList)).Text :=
    ChapterUnitSlot11, ChapterUnitSlot11Edit.Section := "Game", ChapterUnitSlot11Edit.OnEvent("Change",
        sd_UpdateConfigShortcut)
(ChapterUnitSlot21Edit := ChangeLoadout1GUI.AddDropDownList("x170 y33 vChapterUnitSlot21", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot21Edit.Text := ChapterUnitSlot21, ChapterUnitSlot21Edit.Section := "Game",
ChapterUnitSlot21Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot31Edit := ChangeLoadout1GUI.AddDropDownList("x30 y63 vChapterUnitSlot31", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot31Edit.Text := ChapterUnitSlot31, ChapterUnitSlot31Edit.Section := "Game",
ChapterUnitSlot31Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot41Edit := ChangeLoadout1GUI.AddDropDownList("x170 y63 vChapterUnitSlot41", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot41Edit.Text := ChapterUnitSlot41, ChapterUnitSlot41Edit.Section := "Game",
ChapterUnitSlot41Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot51Edit := ChangeLoadout1GUI.AddDropDownList("x30 y93 vChapterUnitSlot51", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot51Edit.Text := ChapterUnitSlot51, ChapterUnitSlot51Edit.Section := "Game",
ChapterUnitSlot51Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot61Edit := ChangeLoadout1GUI.AddDropDownList("x170 y93 vChapterUnitSlot61", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot61Edit.Text := ChapterUnitSlot61, ChapterUnitSlot61Edit.Section := "Game",
ChapterUnitSlot61Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot71Edit := ChangeLoadout1GUI.AddDropDownList("x30 y123 vChapterUnitSlot71", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot71Edit.Text := ChapterUnitSlot71, ChapterUnitSlot71Edit.Section := "Game",
ChapterUnitSlot71Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot81Edit := ChangeLoadout1GUI.AddDropDownList("x170 y123 vChapterUnitSlot81", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot81Edit.Text := ChapterUnitSlot81, ChapterUnitSlot81Edit.Section := "Game",
ChapterUnitSlot81Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot91Edit := ChangeLoadout1GUI.AddDropDownList("x30 y153 vChapterUnitSlot91", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot91Edit.Text := ChapterUnitSlot91, ChapterUnitSlot91Edit.Section := "Game",
ChapterUnitSlot91Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot01Edit := ChangeLoadout1GUI.AddDropDownList("x174 y153 vChapterUnitSlot01", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot01Edit.Text := ChapterUnitSlot01, ChapterUnitSlot01Edit.Section := "Game",
ChapterUnitSlot01Edit.OnEvent("Change", sd_UpdateConfigShortcut)
...
ChangeLoadout1GUI.AddUpDown("xp+26 yp-1 h16 -16 Range5-10 vChapterUnitSlots1UpDown", ChapterUnitSlots1).OnEvent(
    "Change", sd_ChapterUnitSlots1)
ChangeLoadout1GUI.AddText("x322 y51", "Selection Mode:")
UnitModesArr := ["Preset", "Input", "Detect"]
(ChapterUnitMode1Edit := ChangeLoadout1GUI.AddDropDownList("x322 y68 vChapterUnitMode1Edit", UnitModesArr)).Text :=
    ChapterUnitMode1, ChapterUnitMode1Edit.OnEvent("Change", sd_ChapterUnitMode1)
...
sd_ChapterUnitMode1(*) {
global
IniWrite((ChapterUnitMode1 := ChapterUnitMode1Edit.Text), A_SettingsWorkingDir "main_config.ini", "Game",
"ChapterUnitMode1")
...
global
IniWrite((ChangeLoadout1GUI["ChapterUnitSlots1"].Text := ChapterUnitSlots1 := ChangeLoadout1GUI[
    "ChapterUnitSlots1UpDown"].Value), A_SettingsWorkingDir "main_config.ini", "Game", "ChapterUnitSlots1")
sd_ChapterUnitSlots1Locks()
}
...
(ChapterUnitSlot12Edit := ChangeLoadout2GUI.AddDropDownList("x30 y33 vChapterUnitSlot12", UnitNamesList)).Text :=
    ChapterUnitSlot12, ChapterUnitSlot12Edit.Section := "Game", ChapterUnitSlot12Edit.OnEvent("Change",
        sd_UpdateConfigShortcut)
(ChapterUnitSlot22Edit := ChangeLoadout2GUI.AddDropDownList("x170 y33 vChapterUnitSlot22", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot22Edit.Text := ChapterUnitSlot22, ChapterUnitSlot22Edit.Section := "Game",
ChapterUnitSlot22Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot32Edit := ChangeLoadout2GUI.AddDropDownList("x30 y63 vChapterUnitSlot32", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot32Edit.Text := ChapterUnitSlot32, ChapterUnitSlot32Edit.Section := "Game",
ChapterUnitSlot32Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot42Edit := ChangeLoadout2GUI.AddDropDownList("x170 y63 vChapterUnitSlot42", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot42Edit.Text := ChapterUnitSlot42, ChapterUnitSlot42Edit.Section := "Game",
ChapterUnitSlot42Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot52Edit := ChangeLoadout2GUI.AddDropDownList("x30 y93 vChapterUnitSlot52", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot52Edit.Text := ChapterUnitSlot52, ChapterUnitSlot52Edit.Section := "Game",
ChapterUnitSlot52Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot62Edit := ChangeLoadout2GUI.AddDropDownList("x170 y93 vChapterUnitSlot62", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot62Edit.Text := ChapterUnitSlot62, ChapterUnitSlot62Edit.Section := "Game",
ChapterUnitSlot62Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot72Edit := ChangeLoadout2GUI.AddDropDownList("x30 y123 vChapterUnitSlot72", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot72Edit.Text := ChapterUnitSlot72, ChapterUnitSlot72Edit.Section := "Game",
ChapterUnitSlot72Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot82Edit := ChangeLoadout2GUI.AddDropDownList("x170 y123 vChapterUnitSlot82", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot82Edit.Text := ChapterUnitSlot82, ChapterUnitSlot82Edit.Section := "Game",
ChapterUnitSlot82Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot92Edit := ChangeLoadout2GUI.AddDropDownList("x30 y153 vChapterUnitSlot92", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot92Edit.Text := ChapterUnitSlot92, ChapterUnitSlot92Edit.Section := "Game",
ChapterUnitSlot92Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot02Edit := ChangeLoadout2GUI.AddDropDownList("x174 y153 vChapterUnitSlot02", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot02Edit.Text := ChapterUnitSlot02, ChapterUnitSlot02Edit.Section := "Game",
ChapterUnitSlot02Edit.OnEvent("Change", sd_UpdateConfigShortcut)
...
ChangeLoadout2GUI.AddUpDown("xp+26 yp-1 h16 -16 Range5-10 vChapterUnitSlots2UpDown", ChapterUnitSlots2).OnEvent(
    "Change", sd_ChapterUnitSlots2)
ChangeLoadout2GUI.AddText("x322 y51", "Selection Mode:")
UnitModesArr := ["Preset", "Input", "Detect"]
(ChapterUnitMode2Edit := ChangeLoadout2GUI.AddDropDownList("x322 y68 vChapterUnitMode2Edit", UnitModesArr)).Text :=
    ChapterUnitMode2, ChapterUnitMode2Edit.OnEvent("Change", sd_ChapterUnitMode2)
...
sd_ChapterUnitMode2(*) {
global
IniWrite((ChapterUnitMode2 := ChapterUnitMode2Edit.Text), A_SettingsWorkingDir "main_config.ini", "Game",
"ChapterUnitMode2")
...
global
IniWrite((ChangeLoadout2GUI["ChapterUnitSlots2"].Text := ChapterUnitSlots2 := ChangeLoadout1GUI[
    "ChapterUnitSlots2UpDown"].Value), A_SettingsWorkingDir "main_config.ini", "Game", "ChapterUnitSlots2")
sd_ChapterUnitSlots2Locks()
}
...
(ChapterUnitSlot13Edit := ChangeLoadout3GUI.AddDropDownList("x30 y33 vChapterUnitSlot13", UnitNamesList)).Text :=
    ChapterUnitSlot13, ChapterUnitSlot13Edit.Section := "Game", ChapterUnitSlot13Edit.OnEvent("Change",
        sd_UpdateConfigShortcut)
(ChapterUnitSlot23Edit := ChangeLoadout3GUI.AddDropDownList("x170 y33 vChapterUnitSlot23", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot23Edit.Text := ChapterUnitSlot23, ChapterUnitSlot23Edit.Section := "Game",
ChapterUnitSlot23Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot33Edit := ChangeLoadout3GUI.AddDropDownList("x30 y63 vChapterUnitSlot33", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot33Edit.Text := ChapterUnitSlot33, ChapterUnitSlot33Edit.Section := "Game",
ChapterUnitSlot33Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot43Edit := ChangeLoadout3GUI.AddDropDownList("x170 y63 vChapterUnitSlot43", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot43Edit.Text := ChapterUnitSlot43, ChapterUnitSlot43Edit.Section := "Game",
ChapterUnitSlot43Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot53Edit := ChangeLoadout3GUI.AddDropDownList("x30 y93 vChapterUnitSlot53", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot53Edit.Text := ChapterUnitSlot53, ChapterUnitSlot53Edit.Section := "Game",
ChapterUnitSlot53Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot63Edit := ChangeLoadout3GUI.AddDropDownList("x170 y93 vChapterUnitSlot63", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot63Edit.Text := ChapterUnitSlot63, ChapterUnitSlot63Edit.Section := "Game",
ChapterUnitSlot63Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot73Edit := ChangeLoadout3GUI.AddDropDownList("x30 y123 vChapterUnitSlot73", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot73Edit.Text := ChapterUnitSlot73, ChapterUnitSlot73Edit.Section := "Game",
ChapterUnitSlot73Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot83Edit := ChangeLoadout3GUI.AddDropDownList("x170 y123 vChapterUnitSlot83", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot83Edit.Text := ChapterUnitSlot83, ChapterUnitSlot83Edit.Section := "Game",
ChapterUnitSlot83Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot93Edit := ChangeLoadout3GUI.AddDropDownList("x30 y153 vChapterUnitSlot93", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot93Edit.Text := ChapterUnitSlot93, ChapterUnitSlot93Edit.Section := "Game",
ChapterUnitSlot93Edit.OnEvent("Change", sd_UpdateConfigShortcut)
(ChapterUnitSlot03Edit := ChangeLoadout3GUI.AddDropDownList("x174 y153 vChapterUnitSlot03", ["None"])).Add(
    UnitNamesList), ChapterUnitSlot03Edit.Text := ChapterUnitSlot03, ChapterUnitSlot03Edit.Section := "Game",
ChapterUnitSlot03Edit.OnEvent("Change", sd_UpdateConfigShortcut)
...
ChangeLoadout3GUI.AddUpDown("xp+26 yp-1 h16 -16 Range5-10 vChapterUnitSlots3UpDown", ChapterUnitSlots3).OnEvent(
    "Change", sd_ChapterUnitSlots3)
ChangeLoadout3GUI.AddText("x322 y51", "Selection Mode:")
UnitModesArr := ["Preset", "Input", "Detect"]
(ChapterUnitMode3Edit := ChangeLoadout3GUI.AddDropDownList("x322 y68 vChapterUnitMode3Edit", UnitModesArr)).Text :=
    ChapterUnitMode3, ChapterUnitMode3Edit.OnEvent("Change", sd_ChapterUnitMode3)
...
sd_ChapterUnitMode3(*) {
global
IniWrite((ChapterUnitMode3 := ChapterUnitMode3Edit.Text), A_SettingsWorkingDir "main_config.ini", "Game",
"ChapterUnitMode3")
...
global
IniWrite((ChangeLoadout3GUI["ChapterUnitSlots3"].Text := ChapterUnitSlots3 := ChangeLoadout3GUI[
    "ChapterUnitSlots3UpDown"].Value), A_SettingsWorkingDir "main_config.ini", "Game", "ChapterUnitSlots3")
sd_ChapterUnitSlots3Locks()
}
